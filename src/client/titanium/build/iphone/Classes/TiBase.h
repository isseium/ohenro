...
// in simulator we redefine to format for ohenro Developer console
...
{\
	NSString * exceptionName = [@"org.ohenro." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ohenro";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIohenroNativeItemNone = -1, 
	UIohenroNativeItemSpinner = -2,
	UIohenroNativeItemProgressBar = -3,
	
	UIohenroNativeItemSlider = -4,
	UIohenroNativeItemSwitch = -5,
	UIohenroNativeItemMultiButton = -6,
	UIohenroNativeItemSegmented = -7,
	
	UIohenroNativeItemTextView = -8,
	UIohenroNativeItemTextField = -9,
	UIohenroNativeItemSearchBar = -10,
	
	UIohenroNativeItemPicker = -11,
	UIohenroNativeItemDatePicker = -12,
	
	UIohenroNativeItemInfoLight = -13,
	UIohenroNativeItemInfoDark = -14,
	
	UIohenroNativeItemDisclosure = -15,
	
	UIohenroNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ohenro instances of
