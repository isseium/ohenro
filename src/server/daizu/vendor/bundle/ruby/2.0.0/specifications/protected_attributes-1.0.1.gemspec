...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activemodel>, ["< 5.0", ">= 4.0.0.beta"])
      s.add_development_dependency(%q<activerecord>, ["< 5.0", ">= 4.0.0.beta"])
      s.add_development_dependency(%q<actionpack>, ["< 5.0", ">= 4.0.0.beta"])
      s.add_development_dependency(%q<sqlite3>, [">= 0"])
      s.add_development_dependency(%q<mocha>, [">= 0"])
    else
      s.add_dependency(%q<activemodel>, ["< 5.0", ">= 4.0.0.beta"])
